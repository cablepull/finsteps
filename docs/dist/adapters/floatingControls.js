...
export function createFloatingControls(options) {
    const { controller, camera, position = "bottom-right", showPlayPause = true, showPrevNext = true, showZoomControls = true, showStepIndicator = true, autoHide = false, offset = { x: 20, y: 20 }, size = "normal", theme = "dark", playbackSpeed = 3000, showReset = false, orientation = "vertical" } = options;
