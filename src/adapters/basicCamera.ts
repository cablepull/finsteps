 ...
 */
function getElementBBox(element: Element, svg: SVGSVGElement): DOMRect {
 ...
 */
function findAdjacentNodes(targetNode: Element, svg: SVGSVGElement, strategy: DiagramStrategy): Element[] {
